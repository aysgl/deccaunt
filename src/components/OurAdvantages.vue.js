...
function __VLS_template() {
    ...
    [SectionTitle,];
    // @ts-ignore
    const __VLS_6 = __VLS_asFunctionalComponent(SectionTitle, new SectionTitle({ title: ("Our Advantages"), position: ("center"), ...{ class: ("mb-8") }, }));
    const __VLS_7 = __VLS_6({ title: ("Our Advantages"), position: ("center"), ...{ class: ("mb-8") }, }, ...__VLS_functionalComponentArgsRest(__VLS_6));
    ...
    for (const [a] of __VLS_getVForSourceType((__VLS_ctx.advanteges))) {
        ...
        // @ts-ignore
        const __VLS_18 = __VLS_asFunctionalComponent(__VLS_17, new __VLS_17({ cols: ("12"), md: ("6"), lg: ("3"), key: ((a.title)), }));
        const __VLS_19 = __VLS_18({ cols: ("12"), md: ("6"), lg: ("3"), key: ((a.title)), }, ...__VLS_functionalComponentArgsRest(__VLS_18));
        const __VLS_23 = __VLS_resolvedLocalAndGlobalComponents.VCard;
        /** @type { [typeof __VLS_components.VCard, typeof __VLS_components.VCard, ] } */
        // @ts-ignore
        const __VLS_24 = __VLS_asFunctionalComponent(__VLS_23, new __VLS_23({ color: ("light"), ...{ class: ("h-100 rounded-lg pa-6") }, flat: (true), }));
        const __VLS_25 = __VLS_24({ color: ("light"), ...{ class: ("h-100 rounded-lg pa-6") }, flat: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_24));
        ...
        // @ts-ignore
        const __VLS_30 = __VLS_asFunctionalComponent(__VLS_29, new __VLS_29({ ...{ class: ("text-center") }, }));
        const __VLS_31 = __VLS_30({ ...{ class: ("text-center") }, }, ...__VLS_functionalComponentArgsRest(__VLS_30));
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("d-flex justify-center mb-4") }, });
