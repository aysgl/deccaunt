...
function __VLS_template() {
    ...
    [SectionTitle,];
    // @ts-ignore
    const __VLS_6 = __VLS_asFunctionalComponent(SectionTitle, new SectionTitle({ title: ("Our Latest Work"), position: ("center"), ...{ class: ("mb-6") }, }));
    const __VLS_7 = __VLS_6({ title: ("Our Latest Work"), position: ("center"), ...{ class: ("mb-6") }, }, ...__VLS_functionalComponentArgsRest(__VLS_6));
    ...
    for (const [w] of __VLS_getVForSourceType((__VLS_ctx.works))) {
        ...
        // @ts-ignore
        const __VLS_24 = __VLS_asFunctionalComponent(__VLS_23, new __VLS_23({ ...{ class: ("rounded-lg") }, }));
        const __VLS_25 = __VLS_24({ ...{ class: ("rounded-lg") }, }, ...__VLS_functionalComponentArgsRest(__VLS_24));
        const __VLS_29 = __VLS_resolvedLocalAndGlobalComponents.VImg;
        /** @type { [typeof __VLS_components.VImg, ] } */
        // @ts-ignore
        const __VLS_30 = __VLS_asFunctionalComponent(__VLS_29, new __VLS_29({ src: ((w.image)), }));
        const __VLS_31 = __VLS_30({ src: ((w.image)), }, ...__VLS_functionalComponentArgsRest(__VLS_30));
        ...
        // @ts-ignore
        const __VLS_36 = __VLS_asFunctionalComponent(__VLS_35, new __VLS_35({ ...{ class: ("pb-2") }, }));
        const __VLS_37 = __VLS_36({ ...{ class: ("pb-2") }, }, ...__VLS_functionalComponentArgsRest(__VLS_36));
        (w.title);
        ...
        for (const [t] of __VLS_getVForSourceType((w.tags))) {
            const __VLS_47 = __VLS_resolvedLocalAndGlobalComponents.VChip;
            /** @type { [typeof __VLS_components.VChip, ] } */
            // @ts-ignore
            const __VLS_48 = __VLS_asFunctionalComponent(__VLS_47, new __VLS_47({ key: ((t)), ...{ class: ("mb-1") }, size: ("small"), color: ("primary"), text: ((t)), }));
            const __VLS_49 = __VLS_48({ key: ((t)), ...{ class: ("mb-1") }, size: ("small"), color: ("primary"), text: ((t)), }, ...__VLS_functionalComponentArgsRest(__VLS_48));
        }
    ...
    const __VLS_53 = __VLS_resolvedLocalAndGlobalComponents.VCol;
    /** @type { [typeof __VLS_components.VCol, typeof __VLS_components.VCol, ] } */
    // @ts-ignore
    const __VLS_54 = __VLS_asFunctionalComponent(__VLS_53, new __VLS_53({ cols: ("6"), lg: ("3"), md: ("6"), }));
    const __VLS_55 = __VLS_54({ cols: ("6"), lg: ("3"), md: ("6"), }, ...__VLS_functionalComponentArgsRest(__VLS_54));
    const __VLS_59 = __VLS_resolvedLocalAndGlobalComponents.VBtn;
    /** @type { [typeof __VLS_components.VBtn, typeof __VLS_components.VBtn, ] } */
    // @ts-ignore
    const __VLS_60 = __VLS_asFunctionalComponent(__VLS_59, new __VLS_59({ size: ("lg"), variant: ("tonal"), color: ("primary"), ...{ class: ("w-100 h-100 rounded-lg") }, elevation: ("20"), }));
    const __VLS_61 = __VLS_60({ size: ("lg"), variant: ("tonal"), color: ("primary"), ...{ class: ("w-100 h-100 rounded-lg") }, elevation: ("20"), }, ...__VLS_functionalComponentArgsRest(__VLS_60));
    const __VLS_65 = ((__VLS_ctx.IconArrowUpRight));
    // @ts-ignore
    const __VLS_66 = __VLS_asFunctionalComponent(__VLS_65, new __VLS_65({ size: ("30"), }));
    const __VLS_67 = __VLS_66({ size: ("30"), }, ...__VLS_functionalComponentArgsRest(__VLS_66));
