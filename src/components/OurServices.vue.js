...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12({ cols: ("12"), lg: ("6"), }));
    const __VLS_14 = __VLS_13({ cols: ("12"), lg: ("6"), }, ...__VLS_functionalComponentArgsRest(__VLS_13));
    // @ts-ignore
    [SectionTitle,];
    // @ts-ignore
    const __VLS_18 = __VLS_asFunctionalComponent(SectionTitle, new SectionTitle({ title: ("Our services"), ...{ class: ("mb-4") }, }));
    const __VLS_19 = __VLS_18({ title: ("Our services"), ...{ class: ("mb-4") }, }, ...__VLS_functionalComponentArgsRest(__VLS_18));
    __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({ ...{ class: ("text-h4 font-weight-light") }, });
    ...
    /** @type { [typeof __VLS_components.VCol, typeof __VLS_components.VCol, ] } */
    // @ts-ignore
    const __VLS_30 = __VLS_asFunctionalComponent(__VLS_29, new __VLS_29({ cols: ("12"), lg: ("6"), }));
    const __VLS_31 = __VLS_30({ cols: ("12"), lg: ("6"), }, ...__VLS_functionalComponentArgsRest(__VLS_30));
    ...
    for (const [s] of __VLS_getVForSourceType((__VLS_ctx.services))) {
        ...
        /** @type { [typeof __VLS_components.VCol, typeof __VLS_components.VCol, ] } */
        // @ts-ignore
        const __VLS_42 = __VLS_asFunctionalComponent(__VLS_41, new __VLS_41({ cols: ("12"), md: ("6"), lg: ("6"), key: ((s.title)), }));
        const __VLS_43 = __VLS_42({ cols: ("12"), md: ("6"), lg: ("6"), key: ((s.title)), }, ...__VLS_functionalComponentArgsRest(__VLS_42));
        const __VLS_47 = __VLS_resolvedLocalAndGlobalComponents.VCard;
        /** @type { [typeof __VLS_components.VCard, typeof __VLS_components.VCard, ] } */
        // @ts-ignore
        const __VLS_48 = __VLS_asFunctionalComponent(__VLS_47, new __VLS_47({ color: ("white"), height: ("100%"), ...{ class: ("rounded-lg") }, }));
        const __VLS_49 = __VLS_48({ color: ("white"), height: ("100%"), ...{ class: ("rounded-lg") }, }, ...__VLS_functionalComponentArgsRest(__VLS_48));
        const __VLS_53 = __VLS_resolvedLocalAndGlobalComponents.VCardTitle;
        /** @type { [typeof __VLS_components.VCardTitle, typeof __VLS_components.VCardTitle, ] } */
        // @ts-ignore
        const __VLS_54 = __VLS_asFunctionalComponent(__VLS_53, new __VLS_53({ line: ("2"), }));
        const __VLS_55 = __VLS_54({ line: ("2"), }, ...__VLS_functionalComponentArgsRest(__VLS_54));
        (s.title);
        __VLS_nonNullable(__VLS_58.slots).default;
        const __VLS_58 = __VLS_pickFunctionalComponentCtx(__VLS_53, __VLS_55);
        const __VLS_59 = __VLS_resolvedLocalAndGlobalComponents.VCardText;
        /** @type { [typeof __VLS_components.VCardText, typeof __VLS_components.VCardText, ] } */
        // @ts-ignore
        const __VLS_60 = __VLS_asFunctionalComponent(__VLS_59, new __VLS_59({}));
        const __VLS_61 = __VLS_60({}, ...__VLS_functionalComponentArgsRest(__VLS_60));
        (s.description.slice(0, 100));
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("d-flex flex-wrap ga-2 mt-4") }, });
        for (const [t] of __VLS_getVForSourceType((s.tags))) {
            const __VLS_65 = __VLS_resolvedLocalAndGlobalComponents.VChip;
            /** @type { [typeof __VLS_components.VChip, typeof __VLS_components.VChip, ] } */
            // @ts-ignore
            const __VLS_66 = __VLS_asFunctionalComponent(__VLS_65, new __VLS_65({ color: ("primary"), size: ("small"), key: ((t)), }));
            const __VLS_67 = __VLS_66({ color: ("primary"), size: ("small"), key: ((t)), }, ...__VLS_functionalComponentArgsRest(__VLS_66));
            (t);
